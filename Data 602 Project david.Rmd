...
Transforming the data in log format did improve the regression and made all 3 coefficients significant along with the intercept but still does not make sense in the context of the data. With an R-squared of 0.083 the fit of the model does improve in this case drastically from the first model.  
...
reg_corlog
```
With the fire size transformed into log form the data shows slightly more of a linear relationship.
